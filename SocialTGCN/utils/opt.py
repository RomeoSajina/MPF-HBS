...
class Options:
    ...
    def _initial(self):
        ...
        #                     General options
        # ===============================================================
        self.parser.add_argument('--input_time', type=int, default=16, help='size of each model layer') # 25
        self.parser.add_argument('--output_time', type=int, default=14, help='size of each model layer') # 25
        self.parser.add_argument('--joints_num', type=int, default=13, help='number of skeleton joints') # 18
