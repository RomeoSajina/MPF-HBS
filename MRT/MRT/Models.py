...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        self.proj=nn.Linear(self.P_DIM,d_model) # 45: 15jointsx3
        self.proj2=nn.Linear(self.P_DIM,d_model)
        self.proj_inverse=nn.Linear(d_model, self.P_DIM)
        self.l1=nn.Linear(d_model, d_model*4)
        self.l2=nn.Linear(d_model*4, d_model*T)
    ...
    def forward(self, src_seq, trg_seq, input_seq, use=None):
        ...
        others=input_seq[:,:,:,:].view(input_seq.shape[0],-1,self.P_DIM)
