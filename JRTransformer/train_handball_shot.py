...
import torch
import time
from dataset.dataset_handball_shot import DS_train, DS_test, batch_denormalization
...
class Trainer:
    def __init__(self, args):
        ...
        self.rc = args.rc
        dset_train = DS_train(dset_path="", seq_len=args.input_length+args.output_length, N=args.N, J=args.J, split_name="train")
        ...
        dset_val = DS_train(dset_path="", seq_len=args.input_length+args.output_length, N=args.N, J=args.J, split_name="valid")
        ...
        dset_test = DS_test(dset_path="", seq_len=args.input_length+args.output_length, N=args.N, J=args.J)
        ...
        print(args)
        print("\n\n")
        print(len(dset_train), len(dset_val), len(dset_test))
        print("\n\n")
